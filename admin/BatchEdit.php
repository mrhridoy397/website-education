                        ...
                        <div class="col-md-7 offset-md-2">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Edit at new Batch</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $data['data']['id']?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="day1" class="form-control form-control-user" placeholder="Day1" name="day1"  autofocus value="<?php if (isset($_POST['day1'])) { echo $_POST['day1'];}else{echo $data['data']['day1'];} ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                <label for="endDate" class="sr-only">Day2</label>
                                                <input type="text" id="day2" class="form-control form-control-user" placeholder="Day2" name="day2"  autofocus value="<?php if (isset($_POST['day2'])) { echo $_POST['day2'];}else{echo $data['data']['day2'];} ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                <label for="endDate" class="sr-only">Day3</label>
                                                <input type="text" id="day3" class="form-control form-control-user" placeholder="Day3" name="day3"  autofocus value="<?php if (isset($_POST['day3'])) { echo $_POST['day3'];}else{echo $data['data']['day3'];} ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                <label for="endDate" class="sr-only">Day4</label>
                                                <input type="text" id="day4" class="form-control form-control-user" placeholder="Day4" name="day4"  autofocus value="<?php if (isset($_POST['day4'])) { echo $_POST['day4'];}else{echo $data['data']['day4'];} ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                <label for="endDate" class="sr-only">Day5</label>
                                                <input type="text" id="day5" class="form-control form-control-user" placeholder="Day5" name="day5"  autofocus value="<?php if (isset($_POST['day5'])) { echo $_POST['day5'];}else{echo $data['data']['day5'];} ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                <label for="endDate" class="sr-only">Day6</label>
                                                <input type="text" id="day6" class="form-control form-control-user" placeholder="Day6" name="day6"  autofocus value="<?php if (isset($_POST['day6'])) { echo $_POST['day6'];}else{echo $data['data']['day6'];} ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                <label for="endDate" class="sr-only">Day7</label>
                                                <input type="text" id="day7" class="form-control form-control-user" placeholder="Day7" name="day7"  autofocus value="<?php if (isset($_POST['day7'])) { echo $_POST['day7'];}else{echo $data['data']['day7'];} ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 text-center">
                                            <button class="btn btn-md btn-primary btn-primary" type="submit" name="submit">Update batch</button>
