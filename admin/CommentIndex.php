...
$Index = $student->get();
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $student->changestatus($_REQUEST);
...
<body id="page-top">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        ?>
                                            ...
                                            <td><?php echo $i; ?></td>
                                                ...
                                                <td>
                                                    <a href="CommentEdit.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    <script>
        $('.delete').on('click',function(){
            var value = $(this).val();
            var url = "CommentDelete.php?id="+value;
