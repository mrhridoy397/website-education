                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <select name="teacherId" id="teacherId" class="form-control">
                                                ...
                                                ?>
                                            <option value="<?php echo $items['id']; ?>" <?php if (isset($_REQUEST['teacherId']) && $__REQUEST['teacherId'] == $items['id']) { echo "selected";} ?>><?php echo $items['name'] ?></option>
                                            <?php
                                                } 
                                                ?>
                                        </select>
                                        ...
                                        <select name="batchId" id="batchId" class="form-control">
                                            ...
                                            ?>
                                                <option value="<?php echo $items['id']; ?>" <?php if (isset($_REQUEST['batchId']) && $_REQUEST['batchId'] == $items['id']) {echo "selected"; } ?>><?php echo $items['bname'] ?></option>
                                        ...
                                        <label for="coursefee"> Course Fee <sup class="text-danger">*</sup></label>
                                            <input  type="text" name="coursefee" id="coursefee" class="form-control" placeholder=" Course Fee" value="<?php if(isset($_REQUEST['coursefee']))  { echo $__REQUEST['coursefee'];}?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="Discount"> Discount </label>
                                            <input  type="text" name="Discount" id="Discount" class="form-control" placeholder=" Discount" value="<?php if(isset($_REQUEST['Discount']))  { echo $__REQUEST['Discount'];}?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="classSize"> Room Size </label>
                                            <input  type="text" name="classSize" id="classSize" class="form-control" placeholder=" classSize" value="<?php if(isset($_REQUEST['classSize']))  { echo $__REQUEST['classSize'];}?>">
                                        </div>
                                        <div class="form-group">
