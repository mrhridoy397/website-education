...
$data = $custompage->CustomPageedit($_REQUEST['id']);
$menu = $custompage->CustomPage();
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $custompage->CustomPageUpdate($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="CustomPageIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="menuid" id="menuid" class="form-control">
                                                ...
                                                ?>
                                            <option value="<?php echo $item['id'] ?>" <?php if ( $data['menuid'] == $item['id']) { echo "selected";} ?>><?php echo $item['ManuName']; ?></option>
                                            <?php
                                                } 
                                                ?>
                                            </select>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Description"><?php if (isset($_POST['description'])) { echo $_POST['description']; } else { echo $data['description'];} ?></textarea>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="meta_key" class="form-control form-control-user" placeholder="Meta key" name="meta_key" required autofocus value="<?php if (isset($_POST['meta_key'])) { echo $_POST['meta_key']; } else { echo $data['meta_key'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <textarea name="meta_description" id="meta_description" cols="30" rows="10" class="form-control" placeholder="Meta Description"><?php if (isset($_POST['meta_description'])) { echo $_POST['meta_description']; } else { echo $data['meta_description'];} ?></textarea>
                                        ...
                                        <div class="form-group text-center mt-5">
                                            ...
                                            <a href="CustomPageIndex.php" class="btn btn-danger">Cancle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
