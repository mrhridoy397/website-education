...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="EventCreate.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> Add Event</a>
                    </div>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['vanue']; ?></td>
                                                <td><?php echo $data['organizer']; ?></td>
                                                <td><?php echo $data['sponser']; ?></td>
                                                <td>
                                                    <?php
                                                    if ($data['isActive'] == 0) {
                                                        echo "Deactive";
                                                ...
                                                <td>
                                                    <a href="EventEdit.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    <script>
        $('.delete').on('click',function(){
            var value = $(this).val();
            var url = "EventDelete.php?id="+value;
