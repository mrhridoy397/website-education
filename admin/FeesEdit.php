...
$Response = [];
$active = $fees->active;
$data = $fees->edit($_REQUEST['id']);
// $batch = $student->StudentBatch();
// $course = $student->StudentCourse();

if (isset($_REQUEST['submit']) && count($_REQUEST) > 0) $Response = $fees->Update($_REQUEST);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Fees</h1>
                        ...
                        <div class="col-md-12 ">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Edit Fees</h6>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group" id="image-tag">
                                                    ...
                                                    <option>~~select~~</option>
                                                        <option <?php if($data ['type'] == 1){echo "selected";} ?> value="1">Course Fees</option>
                                                        <option <?php if($data ['type'] == 2){echo "selected";} ?> value="2">Registration Fees</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group" id="image-tag">
                                                    ...
                                                    <input type="date" name="paydate" id="paydate" class="form-control" value="<?php echo $data['paydate']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group" id="image-tag">
                                                    <label class="control-label" for="remarks"> Remarks <span class="m-l-5 text-danger"> *</span></label>
                                                    <input type="text" name="remarks" id="remarks" class="form-control" value="<?php echo $data['remarks']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-12 text-center">
                                                <button type="submit" name="submit" id="submit" value="submit" class="btn btn-primary ">Update Payments</button>
