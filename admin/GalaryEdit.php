...
$data = $galary->Galaryedit($_REQUEST['id']);
$Galary = $galary->galary();
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $galary->GalaryUpdate($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="GalaryIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="categorisId" id="categorisId" class="form-control">
                                                ...
                                                ?>
                                            <option value="<?php echo $items['id'] ?>" <?php if ( $data['categorisId'] == $items['id']) { echo "selected";} ?>><?php echo $items['categorisname'] ?></option>
                                            <?php
                                                } 
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group text-center mt-5">
                                            ...
                                            <a href="GalaryIndex.php" class="btn btn-danger">Cancle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
