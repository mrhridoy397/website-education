...
// $News = $Batch->getNews();
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $galarycategoris->createGalarycategoris($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Create Galarycategoris</h1>
                        <a href="GalarycategorisIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All Galarycategoris</a>
                    </div>
                        ...
                        <div class="col-md-7 offset-md-2">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Create at Galarycategoris</h6>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" class="form-signin" >
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" id="categorisname" class="form-control form-control-user" placeholder="Categoris Name" name="categorisname" required autofocus value="<?php if (isset($_POST['categorisname'])) echo $_POST['categorisname']; ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 text-center">
                                            ...
                                            <a href="GalarycategorisIndex.php" class="btn btn-md btn-primary btn-danger">Cencle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
