...
$data = $comments->edit($_REQUEST['id']);

if (isset($_REQUEST['submit']) && count($_REQUEST) > 0) $Response = $comments->Update($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="NewsCommentIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                                        ...
                                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                            ...
                                            <div class="tile-body">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <input type="hidden" name="blogid" value="<?php echo $data['blogid']; ?>">
                                                        <div class="col-md-6">
                                                ...
                                                <div class="col-12 offset-md-5">
                                                        ...
                                                        <a href="NewsCommentIndex.php" class="btn btn-danger">Cancle</a>
                                                    </div>
                                            </div>
                                        </form>
                                    </div>
