                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="btnTwo" class="form-control form-control-user" placeholder="Button Two text" name="btnTwo"  autofocus value="<?php if (isset($_POST['btnTwo'])){ echo $_POST['btnTwo'];} else { echo $data['btnTwo'];} ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                <label for="btnTwoLink" class="sr-only">Button Two URL</label>
                                                <input type="text" id="btnTwoLink" class="form-control form-control-user" placeholder="Button Two URL" name="btnTwoLink"  autofocus value="<?php if (isset($_POST['btnTwoLink'])){ echo $_POST['btnTwoLink'];} else { echo $data['btnTwoLink'];} ?>">
                                            </div>
                                                </di>
                                        <div class="form-group">
