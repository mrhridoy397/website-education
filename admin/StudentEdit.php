                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control " type="text"  id="discounts" placeholder="Relation" value="<?php if (isset($_REQUEST['discount'])) {
                                                                                                                                                                    echo $__REQUEST['discount'];
                                                                                                                                                                } else {
                                                                                                                                                                    echo $data['discount'];
                                                                                                                                                                } ?>" disabled>
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control " type="text"  id="coursefees" placeholder="Relation" value="<?php if (isset($_REQUEST['coursefee'])) {
                                                                                                                                                                    echo $__REQUEST['coursefee'];
                                                                                                                                                                } else {
                                                                                                                                                                    echo $data['coursefee'];
                                                                                                                                                                } ?>" disabled>
