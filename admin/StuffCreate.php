                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control " type="text" name="subject" id="subject" placeholder="Web Developer" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label" for="desigmation">Stuff Designation<span class="m-l-5 text-danger"> *</span> </label>
                                                        <input class="form-control " type="text" name="desigmation" id="desigmation" placeholder="Director" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control " type="text" name="salary" id="salary" placeholder="Selary" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group" id="image-tag">
                                                        <label class="control-label" for="image">Stuff Image <span class="m-l-5 text-danger"> *</span></label>
