...
$data = $testmonial->Testmonialedit($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $testmonial->TestmonialUpdate($_REQUEST, $_FILES);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="TestmonialIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" class="form-control form-control-user" placeholder="Name" name="name" required autofocus value="<?php if (isset($_POST['name'])) {
                                                                                                                                                                                            echo $_POST['name'];
                                                                                                                                                                                        } else {
                                                                                                                                                                                            echo $data['name'];
                                                                                                                                                                                        } ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="class" class="form-control form-control-user" placeholder="Department" name="class" required autofocus value="<?php if (isset($_POST['class'])) {
                                                                                                                                                                                                echo $_POST['class'];
                                                                                                                                                                                            } else {
                                                                                                                                                                                                echo $data['class'];
                                                                                                                                                                                            } ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <textarea name="massage" id="massage" cols="30" rows="10" class="form-control" placeholder="Massage"><?php if (isset($_POST['massage'])) {echo $_POST['massage']; } else {echo $data['massage'];} ?></textarea>
                                        ...
                                        <div class="form-group text-center mt-5">
                                            ...
                                            <a href="./TestmonialIndex.php" class="btn btn-danger">Cancle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
