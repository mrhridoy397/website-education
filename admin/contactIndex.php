...
$Index = $student->get();
if (isset($_REQUEST) && count($_REQUEST) > 0) $Response = $student->statuschange($_REQUEST);
...
<body id="page-top">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        ?>
                                            ...
                                            <td><?php echo $i; ?></td>
                                                ...
                                                <td>
                                                    <a href="contactEdit.php?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
    ...
    <script>
        $('.delete').on('click',function(){
            var value = $(this).val();
            var url = "contactDelete.php?id="+value;
