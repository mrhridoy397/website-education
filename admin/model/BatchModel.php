...
class BatchModel extends Db
{
    ...
    {
        $this->query("INSERT INTO `batch`(`bname`, `seat`, `startDate`, `endDate`, `day1`, `day2`, `day3`, `day4`, `day5`, `day6`, `day7`, `status`) 
        VALUES (:bname,:seat,:start,:end,:d1,:d2,:d3,:d4,:d5,:d6,:d7,:status)");
