 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item">
         ...
         <div id="cms" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
             ...
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="contactIndex.php">Massage</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="CommentIndex.php">Comment</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="TestmonialIndex.php">Testmonial</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="NewsIndex.php">News</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="subscribeIndex.php">Subscribe</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="NewsCommentIndex.php">NewsComment</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="EventIndex.php">Event</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="GalarycategorisIndex.php">Galarycategoris</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="CustommenuIndex.php">Custom Menu</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="GalaryIndex.php">Galary</a>
             </div>
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="CustomPageIndex.php">CustomPage</a>
             </div>
         </div>
     </li>
